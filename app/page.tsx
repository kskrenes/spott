        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center relative z-10">
          <div className="text-center sm:text-left">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold mb-6 leading-[0.95] tracking-tight">
              Discover &<br/>
              create amazing<br/>
              <span className="bg-linear-to-r from-blue-400 via-purple-400 to-orange-400 text-transparent bg-clip-text">events.</span>
            </h1>
            <p className="text-gray-400 text-lg sm:text-xl mb-12 max-w-lg font-light">
          ...
          <div>
            <Image src="/3d-react.png" alt="hero image" width={700} height={700} className="w-full h-auto" priority />
          </div>
        </div>
      </section>
    </div>
